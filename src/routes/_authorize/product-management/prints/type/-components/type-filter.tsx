import { PrintTypeStatusOptions } from "@/constants/prints"
...
export function TypeFilter() {
  const { handleSetFilter, handleRefetchData, isRefetching } = usePrintType()
  ...
  const handleResetFilter = () => {
    ...
    navigate({
      ...
      search: PrintTypeSearchSchema.parse({}),
      replace: true,
    })
  }
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="col-span-1">
          <InputField
            ...
            placeholder="Search by print type name"
            value={searchText}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="col-span-1">
              <ComboboxMulti
                ...
                options={PrintTypeStatusOptions}
                allowClear
                modal
                onChange={(value) => {
                  handleSetFilter({
