...
import { CircleCheckBigIcon, CircleXIcon, PrinterIcon } from "lucide-react"
import { usePrintType } from "../-print-type-context"

export function TypeAnalytics() {
  const { analytics } = usePrintType()

  const data = [
    {
      id: "total-print-types",
      label: "Total print types",
      value: analytics.totalPrintType,
      icon: <PrinterIcon className="size-8 text-primary" />,
      bgColor: "bg-primary/10",
    },
    {
      id: "active-print-types",
      label: "Active print types",
      value: analytics.activePrintType,
      icon: <CircleCheckBigIcon className="size-8 text-success-foreground" />,
      bgColor: "bg-success-foreground/10",
    },
    {
      id: "inactive-print-types",
      label: "Inactive print types",
      value: analytics.inactivePrintType,
