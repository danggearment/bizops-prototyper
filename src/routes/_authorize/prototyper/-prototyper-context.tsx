...
const MOCK_CASE_STUDIES: CaseStudyType[] = [
  {
    ...
    description: "How we built a real-time analytics dashboard for a major e-commerce client",
    thumbnail: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&q=80",
    content: "This case study demonstrates the implementation of a real-time dashboard using WebSocket connections and React Query for data synchronization. We achieved sub-second data updates with minimal server load.",
    order: 1,
  ...
  },
  {
    ...
    description: "Performance optimization strategies that enabled our dashboard to handle massive traffic",
    thumbnail: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&q=80",
    content: "Through strategic code-splitting, lazy loading, and aggressive caching, we reduced initial load time by 70% while supporting 1M+ daily active users.",
    order: 2,
  ...
  },
  {
    ...
    description: "Seamlessly integrating 5+ payment providers with fallback mechanisms",
    thumbnail: "https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=800&q=80",
    content: "Our payment gateway prototype successfully integrated Stripe, PayPal, Square, Authorize.net, and local payment providers with automatic fallback and retry logic.",
    order: 1,
  ...
  },
  {
    ...
    content: "Complete documentation of our security implementation, encryption strategies, and compliance process for handling sensitive payment data.",
    order: 2,
  ...
  },
  {
    ...
    description: "Building a comprehensive customer profile system with unified data",
    thumbnail: "https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=800&q=80",
    content: "We created a unified customer profile system that aggregates data from multiple sources including orders, support tickets, and preferences.",
    order: 1,
...
const MOCK_DATA: PrototypeType[] = [
  {
    ...
    caseStudies: MOCK_CASE_STUDIES.filter(cs => cs.prototypeId === "PROTO-001"),
  ...
  },
  {
    ...
    caseStudies: MOCK_CASE_STUDIES.filter(cs => cs.prototypeId === "PROTO-002"),
  ...
  },
  {
    ...
    caseStudies: MOCK_CASE_STUDIES.filter(cs => cs.prototypeId === "PROTO-003"),
