import { useFinanceAPICallLogsQuery } from "@/data-center/call-logs/use-query"
...
export default function FinanceAPITable() {
  ...
  const { data, isLoading } = useFinanceAPICallLogsQuery({
    paging,
    filter,
  })
