import { useStoreWebhookCallLogsQuery } from "@/data-center/call-logs/use-query"
...
export default function StoreWebhookTable() {
  ...
  const { data, isLoading } = useStoreWebhookCallLogsQuery({
    paging,
    filter,
  })
