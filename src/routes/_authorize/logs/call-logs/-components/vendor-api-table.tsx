import { useVendorAPICallLogsQuery } from "@/data-center/call-logs/use-query"
...
export default function VendorAPITable() {
  ...
  const { data, isLoading } = useVendorAPICallLogsQuery({
    paging,
    filter,
  })
